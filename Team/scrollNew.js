var mq = window.matchMedia( "(max-width: 1247px)" );
if (mq.matches) {
let count=0;
const member = [{
...
const coordinators= document.querySelectorAll(".eachCoordinator");
...
function showMember(count)
{
    ...
    coordinators[1].remove();
    coordinators[2].remove();
    coordinators[3].remove();
